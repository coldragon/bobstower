...
void coreInit(leCore *CORE)
{
	...
	CORE->TEXPACK.screentitle = TextureCreate(CORE->RENDER, "res/img/screentitle.png", 255, 0, 255, 255);
	CORE->TEXPACK.sortset = TextureCreate(CORE->RENDER, "res/img/sortset.png", 255, 0, 255, 255);
	CORE->TEXPACK.guiset = TextureCreate(CORE->RENDER, "res/img/guiset.png", 255, 0, 255, 255);
	CORE->TEXPACK.loose = TextureCreate(CORE->RENDER, "res/img/loose.png", 255, 0, 255, 255);
	CORE->FONT = TTF_OpenFont("res/ttf/FiraSans-Medium.ttf", 10);

	// AUDIO
	CORE->AUDIO.sound1 = Mix_LoadWAV("res/snd/loot1.wav"); // loot1
	CORE->AUDIO.sound2 = Mix_LoadWAV("res/snd/loot2.wav");  // loot2
	CORE->AUDIO.sound3 = Mix_LoadWAV("res/snd/loot3.wav"); // loot3
	CORE->AUDIO.sound4 = Mix_LoadWAV("res/snd/hit1.wav"); // hit1
	CORE->AUDIO.sound5 = Mix_LoadWAV("res/snd/mort1.wav"); // mort1
	CORE->AUDIO.sound6 = Mix_LoadWAV("res/snd/fireball1.wav"); // hit1
	CORE->AUDIO.sound7 = Mix_LoadWAV("res/snd/attackenm.wav"); // hit1
	CORE->AUDIO.sound8 = Mix_LoadWAV("res/snd/hit3.ogg");
	CORE->AUDIO.music1 = Mix_LoadMUS("res/snd/music.ogg");
...
{
	BOB->skin=TextureCreate(render, "res/img/bob.png", 255, 0, 255, 255);
	BOB->skinPos.x=0;
	BOB->skinPos.y=0;
...
{
	BOB.skin=TextureCreate(render, "res/img/gob1.png", 255, 0, 255, 255);
	BOB.skinPos.x=0;
	BOB.skinPos.y=0;
	BOB.skinPos.w=TCASE;
	BOB.skinPos.h=TCASE;
